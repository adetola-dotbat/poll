        ...
        <div class="nk-block nk-block-lg">
            <div class="nk-block-head">
                <div class="nk-block-head-content">
                    <h4 class="title nk-block-title">Senatorial Result Display</h4>
                    <p>Sokoto State</p>
                </div>
            </div>
            <div class="row g-gs">
                        ...
                        <div class="card-inner">
                            <div class="team">
                                ...
                                <div class="user-card user-card-s2">
                                    ...
                                    <div class="user-info">
                                        <h6>WEST SENATORIAL</h6>
                                    </div>
                                </div>
                                <ul class="team-info">
                                    <li><span>APC</span><span>{{ $west_apc }} </span></li>
                                    <li><span>LP</span><span>{{ $west_lp }}</span></li>
                                    <li><span>PDP</span><span>{{ $west_pdp }}</span>

                                    <li><span>Others</span><span>{{ $west_others }}</span>
                                    </li>
                                </ul>
                                <div class="team-view"><a href="{{ route('west.report') }}"
                                        class="btn btn-block btn-dim btn-primary"><span>Check Details</span></a></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-inner">
                            <div class="team">
                                ...
                                <div class="user-card user-card-s2">
                                    ...
                                    <div class="user-info">
                                        <h6>CENTRAL SENATORIAL</h6>
                                    </div>
                                </div>
                                <ul class="team-info">
                                    <li><span>APC</span><span>{{ $central_apc }} </span></li>
                                    <li><span>LP</span><span>{{ $central_lp }}</span></li>
                                    <li><span>PDP</span><span>{{ $central_pdp }}</span>

                                    <li><span>Others</span><span>{{ $central_others }}</span>
                                    </li>
                                </ul>
                                <div class="team-view"><a href="{{ route('central.report') }}"
                                        class="btn btn-block btn-dim btn-primary"><span>Check Details</span></a></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-inner">
                            <div class="team">
                                ...
                                <div class="user-card user-card-s2">
                                    ...
                                    <div class="user-info">
                                        <h6>EAST SENATORIAL</h6>
                                    </div>
                                </div>
                                <ul class="team-info">
                                    <li><span>APC</span><span>{{ $east_apc }} </span></li>
                                    <li><span>LP</span><span>{{ $east_lp }}</span></li>
                                    <li><span>PDP</span><span>{{ $east_pdp }}</span>

                                    <li><span>Others</span><span>{{ $east_others }}</span>
                                    </li>
                                </ul>
                                <div class="team-view"><a href="{{ route('east.report') }}"
                                        class="btn btn-block btn-dim btn-primary"><span>Check Details</span></a></div>
                            </div>
                        </div>
                    </div>
