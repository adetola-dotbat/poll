    ...
    <div class="container">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="home">
                <form class="well form-horizontal" action="{{ route('president.store') }}" method="post"
                    id="contact_form">
                    @csrf
                    <fieldset>
                        ...
                        <!-- Text input-->
                        <input type="hidden" value="{{ session('loginUser') }}" name="user">
            ...
            <div class="tab-pane fade" id="profile">
                ...
                <form class="well form-horizontal" action="{{ route('senate.store') }}" method="post"
                    id="contact_form">
                    @csrf
                    <fieldset>
            ...
            <div class="tab-pane fade" id="messages">
                <form class="well form-horizontal" action="{{ route('rep.store') }}" method="post"
                    id="contact_form">
                    @csrf
                    <fieldset>
